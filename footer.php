...
<section class="title movIn">
        <div class="container">
            ...
            <div class="services">
              ...
              <a href="<?php echo get_template_directory_uri(); ?>/about-us"><img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/img/about.png" alt="">
              <div class="card-body">
            ...
            <div class="col-4 col-md-2 card">
              <a href="<?php echo get_template_directory_uri(); ?>/development"><img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/img/website development.png" alt="">
              <div class="card-body">
                <p class="card-text">Website Development</p>
              </div>
              </a>
            </div>

            <div class="col-4 col-md-2 card">
              <a href="<?php echo get_template_directory_uri(); ?>/design"><img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/img/Design.png" alt="">
              <div class="card-body">
            ...
            <div class="col-4 col-md-2 card">
              <a href="<?php echo get_template_directory_uri(); ?>/seo"><img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/img/SEO.png" alt="">
              <div class="card-body">
                <p class="card-text">SEO Promotion</p>
              </div>
              </a>
            </div>

            <div class="col-4 col-md-2 card">
              <a href="<?php echo get_template_directory_uri(); ?>/apps"><img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/img/APPdevelopment.png" alt="">
              <div class="card-body">
            ...
            <div class="col-4 col-md-2 card">
              <a href="<?php echo get_template_directory_uri(); ?>/portfolio"><img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/img/Portfolio.png" alt="">
              <div class="card-body">
...
<!--Footer-->
 <footer class="navbar-bottom">
    <div class="footer-bottom">
        <div class="container">
            <p style="text-align: center;">IT WORLDS - DIGITAL AGENCY © 2020<br>MAGERRAMOV ELNUR</p>
        </div>
    </div>
</footer>
<!--/Footer-->
			...
			?>
            <video playsinline autoplay muted loop poster="<?php echo get_template_directory_uri(); ?>/assets/video/Words.jpg"  class="fullscreen-bg__video" > 
               <source src="<?php echo get_template_directory_uri(); ?>/assets/Words.webm" type="video/webm">
                <source src="<?php echo get_template_directory_uri(); ?>/assets/Words.mp4" type="video/mp4">
               <source src="<?php echo get_template_directory_uri(); ?>/assets/Words.ogv" type="video/ogg">
        ...
        var n, s, r, a, o, h = function(t) {
            ...
            m = function(n, s, r, a) {
                ...
                this.check = function(l) {
                    ...
                    if (0 === g && r)
                        for (u = ("com.greensock." + n).split("."), c = u.pop(), p = h(u.join("."))[c] = this.gsClass = r.apply(r, o), a && (i[c] = p, "function" == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/site/" : "") + n.split(".").pop(), [], function() {
                                return p
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    function() {
        function t() {
            ...
            for (var r in d) {
                var T = new l(d[r], 2 + 2 * Math.random(), "#00DEFF");
                d[r].circle = T
            }
        }
        ...
        function h(t) {
            if (t.active)
                for (var e in t.closest) m.beginPath(), m.moveTo(t.x, t.y), m.lineTo(t.closest[e].x, t.closest[e].y), m.strokeStyle = "rgb(0,222,255," + t.active + ")", m.stroke()
        }
        ...
        function l(t, e, i) {
            ...
            ! function() {
                ...
                n.active && (m.beginPath(), m.arc(n.pos.x, n.pos.y, n.radius, 0, 2 * Math.PI, !1), m.fillStyle = "rgb(0,222,255," + n.active + ")", m.fill())
            }
        }
