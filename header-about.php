...
<head>
  ...
  ?>
    <title>IT WORLDS - DIGITAL AGENCY | Company Details, Team of professionals</title>
<?
  }
  
  else{
?>
   <title>IT WORLDS - DIGITAL AGENCY | Сведения о компании, Команда профессионалов</title>
  <?
  }
    ?>
...
?>"/>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/stylesheet/about-us.css">
