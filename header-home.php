...
"/>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/stylesheet/main.css">
               ...
               <div class="ml-auto order-0">
                <ul class="navbar-nav socil-net">
                    <li class="nav-item social">
                         <a href="<?php the_field('instagram_url' , 'option');?>"><img src="<?php echo get_template_directory_uri(); ?>/images/instagram.svg"></a>
                    </li>
                    <li class="nav-item social">
                        <a href="<?php the_field('facebook_url' , 'option');?>"><img src="<?php echo get_template_directory_uri(); ?>/images/facebook.svg"></a>
                    </li>
                    <li class="nav-item social">
                        <a href="<?php the_field('vk_link','option');?>"><img src="<?php echo get_template_directory_uri(); ?>/images/vk.svg"></a>
                    </li>
                </ul>
            </div>
